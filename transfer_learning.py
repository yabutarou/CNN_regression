...
#画像ディレクトリ
test_dir ="cifar230120_re_resolution_prydown2"
...
model.load_weights('weights230120_test_prydown0_batch16_epoch20.h5', by_name=True)#.build()で入力画像のサイズを指定しないとうまくいかない
...
model.save('weights230120_test_high_to_low_batch16_epoch20.h5');
