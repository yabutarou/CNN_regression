...
model.compile(loss='mean_squared_error', optimizer=optimizers, metrics=['accuracy'])#「categorical_crossentropy」はワンホット エンコードされたターゲットで機能するのに対し、「sparse_categorical_crossentropy」は整数ターゲットで機能するため、エラーが発生しました # mean_squared_errorで動き出した
...
model.save('weights_kaiki_test_batch16_epoch20_nitika.h5');
